...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query(value = "SELECT * FROM product WHERE user_no = ? AND p_type LIKE ? AND p_title LIKE ?", nativeQuery = true)
    public List<Product> findByUser_noAndP_typeAndKeyword(int user_no, String p_type, String keyword);
